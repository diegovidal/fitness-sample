...
import com.example.fitnesssample.other.Constants.CANCEL_TRACKING_DIALOG_TAG
import com.example.fitnesssample.other.Constants.MAP_ZOOM
import com.example.fitnesssample.other.Constants.POLYLINE_COLOR
import com.example.fitnesssample.other.Constants.POLYLINE_WIDTH
import com.example.fitnesssample.other.TrackingUtility
import com.example.fitnesssample.services.Polyline
import com.example.fitnesssample.services.TrackingService
...
class TrackingFragment : Fragment(R.layout.fragment_tracking) {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        if(savedInstanceState != null) {
            ...
            cancelTrackingDialog?.setOnPositiveClick {
                stopRun()
            }
        }
    ...
    private fun subscribeToObservers() {
        ...
        TrackingService.timeRunInMillis.observe(viewLifecycleOwner, Observer {
            ...
            curTimeInMillis = it
            val formattedTime = TrackingUtility.fetchFormattedStopWatchTime(curTimeInMillis, true)
    ...
    private fun endRunAndSaveToDb() {
        ...
        map?.snapshot { bmp ->
            ...
            val caloriesBurned = ((distanceInMeters / 1000f) * setupContent.weight).toInt()

            val run = RunDTO(bmp, dateTimestamp, avgSpeed, distanceInMeters, curTimeInMillis, caloriesBurned)
